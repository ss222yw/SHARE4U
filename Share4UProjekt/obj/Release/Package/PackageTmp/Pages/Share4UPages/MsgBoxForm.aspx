...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="showImgLayout2">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBody" runat="server" TextMode="MultiLine" placeholder="Skriv ditt meddelande här." CssClass="message"></asp:TextBox><span>*</span>
            ...
            <tr>
                <td>
                    <label for="chkShowPassword">
                        <input type="checkbox" id="chkShowPassword" onkeydown="return (event.keyCode!=13);" />
                        Visa Lösenord</label></td>
                <td>
    ...
    <%--    Tagit från http://www.aspsnippets.com/Articles/Show-Hide-Password-in-Password-TextBox-with-CheckBox-using-jQuery.aspx--%>
