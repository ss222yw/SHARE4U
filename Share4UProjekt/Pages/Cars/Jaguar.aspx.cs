...
namespace Share4UProjekt.Pages.Cars
{
    public partial class Jaguar : System.Web.UI.Page
    {
        ...
        protected void closeImg_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.RedirectToRoute("Jaguar",close);
        }
        ...
        {
            return Service.GetImagesPageWiseByID(maximumRows, startRowIndex, out totalRowCount, 16);
        }
        ...
        protected void ImageFavoriteButton_Command(object sender, CommandEventArgs e)
        {
            if (Access_Token != null)
            {
                ...
                Response.RedirectToRoute("Jaguar");
            }
            else
            {
