...
{
    public partial class Lexus : System.Web.UI.Page
    {
        ...
        protected void closeImg_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.RedirectToRoute("Lexus",close);
        }
        ...
        {
            return Service.GetImagesPageWiseByID(maximumRows, startRowIndex, out totalRowCount, 20);
        }
        ...
        protected void ImageFavoriteButton_Command(object sender, CommandEventArgs e)
        {
            if (Access_Token != null)
            {
                ...
                Response.RedirectToRoute("Lexus");
            }
            else
            {
