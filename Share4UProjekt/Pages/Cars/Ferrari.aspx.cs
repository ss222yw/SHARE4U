...
namespace Share4UProjekt.Pages.Cars
{
    public partial class Ferrari : System.Web.UI.Page
    {
        ...
        protected void closeImg_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.RedirectToRoute("Ferrari",close);
        }
        ...
        {
            return Service.GetImagesPageWiseByID(maximumRows, startRowIndex, out totalRowCount, 11);
        }
        ...
        protected void ImageFavoriteButton_Command(object sender, CommandEventArgs e)
        {
            if (Access_Token != null)
            {
                ...
                Response.RedirectToRoute("Ferrari");
            }
            else
            {
