...
{
    public partial class Peugeot : System.Web.UI.Page
    {
        ...
        protected void closeImg_Click(object sender, ImageClickEventArgs e)
        {
            ...
            Response.RedirectToRoute("Peugeot",close);
        }
        ...
        {
            return Service.GetImagesPageWiseByID(maximumRows, startRowIndex, out totalRowCount, 27);
        }
        ...
        protected void ImageFavoriteButton_Command(object sender, CommandEventArgs e)
        {
            if (Access_Token != null)
            {
                ...
                Response.RedirectToRoute("Peugeot");
            }
            else
            {
